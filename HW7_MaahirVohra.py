...
def litCricFriend(wordList, text):
    ...
    ratio = wordCount / len(text)
    print('Frequency of:', wordList, '= ', ratio)
...
'''
It seems that there is a very slight difference in the way that
they use 'a' and 'an'. For the most part, they use it the same. But
the difference in regions between each poet could have resulted in the
slight variation in which they use 'a' and 'an'. This is also the same for 
'the', they don't use it much differently, but there is a slight difference.
'''
